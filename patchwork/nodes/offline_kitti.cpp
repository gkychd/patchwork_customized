...
int main(int argc, char**argv) {
    ...
    nh.param<string>("/acc_filename", acc_filename, "/");
    ...
    for (int n = 0; n < N; ++n) {
        ...
        int gt_ground_nums;
        calculate_precision_recall(pc_curr, pc_ground, precision, recall, gt_ground_nums);
        calculate_precision_recall(pc_curr, pc_ground, precision_naive, recall_naive, gt_ground_nums, false);
...
// -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
        if(save_csv){
            ...
            //cout << "save_csv path: " << output_filename << endl;
            ...
            ofstream ground_nums_output(output_gtpoints_name, ios::app);
            ground_nums_output << n << "," << gt_ground_nums;
            ground_nums_output << std::endl;
            ground_nums_output.close();
        }
